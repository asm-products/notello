...
var loginComponent = React.createClass({
	...
	render: function () {
		...
		return 	<div className="login-container">
					...
					{this.state.isAuthenticated && <span className="login-btn bracket-animation" title={this.state.email} onTouchEnd={this.handleLogout} onClick={this.handleLogout}>LOGOUT</span>}
